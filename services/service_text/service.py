...
log_file = os.path.join(base_log_dir, "service-logs", "service-text-logs.txt")
...
def convert_docx_to_pdf():
    logging.info("Pedido recebido para conversão de DOCX para PDF.")
    ...
    if not file.filename.lower().endswith('.docx'):
        logging.warning("Formato de ficheiro inválido. Apenas .docx é suportado.")
    ...
    try:
        ...
        logging.info(f"Ficheiro {filename} convertido com sucesso para PDF.")
